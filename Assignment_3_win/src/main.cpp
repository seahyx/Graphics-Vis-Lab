...
int LoadTexture()
{
    ...
    //taking from standard input
    cout << "Please enter the texture filename.png: ";
    cin >> inputString;
    cout << "Displaying: " << inputString <<endl;
    ...
    if (myfile.is_open() == false)
    {
        cout << "Error: cannot open the texture image file.";
        return 1;
    }

    /////////////////////////////////////////////////////
    // 2. Load image, create texture and generate mipmaps
    
    int width, height, nrChannels;
    unsigned char *data = stbi_load(inputString.c_str(), &width, &height, &nrChannels, 0);
    if (data)
    {
